...
public class CheckingAccount extends AbstractAccount {
	...
	private static final Logger logger = LogManager.getLogger(CheckingAccount.class.getName());
	/**
	 * 
	 */
	...
	public CheckingAccount(String ...acctHolder) {
		super(acctHolder);
		this.type = AbstractAccount.AccountType.CHECKING;
	}
	...
	public void transfer(double amount, Account fromAccount, Account toAccount) {
		...
		this.getLogger().error("TRANSFER - FROM: "+fromAccount+" TO: "+toAccount+" AMOUNT: $"+amount);
	}
}
