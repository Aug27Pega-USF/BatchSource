...
--ALTER TABLES FOR FK RELATIONSHIP
ALTER TABLE BEAR
...
INSERT INTO CAVE VALUES(1,'BAT',17);
INSERT INTO BEAR VALUES(1,2,'GREG','10-NOV-2015',DEFAULT,1);
INSERT INTO BEAR VALUES(2,3,'ROGER', '25-DEC-1941', 6000,1);

SELECT * FROM BEAR;

UPDATE BEAR SET BEAR_NAME= 'GAVIN' WHERE BEAR_ID =1;
DELETE FROM BEAR WHERE BEAR_WEIGHT <  300;

--TRUNCATE TABLE BEAR_TYPE;<-DUMB
