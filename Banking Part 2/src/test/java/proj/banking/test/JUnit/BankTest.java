			...
			class CreateNewUserTest {
				...
				class CreateTest {
					...
					void userNameExists () throws SQLException {
						assertEquals(NewUser.USERNAME_EXIST, bank.createUserID(900000001, "user01", "pass03", tmpCust, 1));
					}
					
					@Test
					void accountIDExists () throws SQLException {
						assertEquals(NewUser.USER_ACC_NUM_TAKEN, bank.createUserID(999999999, "user03", "pass03", tmpCust, 1));
					}
				}
				...
				class UpdateTest {
					...
					void setup() throws SQLException {
						...
						tmpCust2 = new UserAccountInfo("900000001,Two,Two,twoTest@one.com,222-222-2222,2222-22-22,222 Two Lane,TW,22222,".split(","));				
					}
					@AfterAll
