...
public interface User_Info_Dao {
	...
	public abstract User_Info getUserById(int id) throws SQLException;
	public abstract void updateUser_Info(int id, String username, String password, String first, String last) throws SQLException;
