...
public class Bank_Account {
	...
	private User_Info user_id;//for now i am using object user i might change it to int if issue arise
	private double saving_balance;
	private double checking_balance;
	
	public Bank_Account() {}

	public Bank_Account(int bank_account_id, int account_number, User_Info user_id, double saving_balance,
...
public double withdrawFromchecking(double amount) {
	...
	public String toString() {
		return "Account [bank_account_id=" + bank_account_id + ", account_number=" + account_number + ", user_id="
