 ...
 * 2018-07-31T15:50:44.572-04:00
 * Generated source version: 3.1.6
 * 
 */
@WebServiceClient(name = "messageGenService", 
                  wsdlLocation = "http://localhost:9006/SOAPGreeting/greetingservice?wsdl",
                  targetNamespace = "http://ws.example.com/") 
public class MessageGenService extends Service {

    public final static URL WSDL_LOCATION;

    public final static QName SERVICE = new QName("http://ws.example.com/", "messageGenService");
    public final static QName MessageGenImplPort = new QName("http://ws.example.com/", "MessageGenImplPort");
    static {
        URL url = null;
        try {
            url = new URL("http://localhost:9006/SOAPGreeting/greetingservice?wsdl");
        } catch (MalformedURLException e) {
            java.util.logging.Logger.getLogger(MessageGenService.class.getName())
                .log(java.util.logging.Level.INFO, 
                     "Can not initialize the default wsdl from {0}", "http://localhost:9006/SOAPGreeting/greetingservice?wsdl");
        }
        WSDL_LOCATION = url;
    }
