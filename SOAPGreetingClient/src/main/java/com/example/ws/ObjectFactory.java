...
public class ObjectFactory {
    ...
    private final static QName _GetMessage_QNAME = new QName("http://ws.example.com/", "getMessage");
    private final static QName _GetMessageResponse_QNAME = new QName("http://ws.example.com/", "getMessageResponse");
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://ws.example.com/", name = "getMessage")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://ws.example.com/", name = "getMessageResponse")
