...
--TASK
--THIS TASK ISN'T COMPLETE BECAUSE i DIDN'T NOT CREATE A UDF, STILL WORKING ON IT FOUND OUT LAST MINUTE
...
/
--TASK B
--DIDN'T COMPLETE THIS ONE RAN OUT OF TIME STILL WORKING ON A COUPLE UDR'S
