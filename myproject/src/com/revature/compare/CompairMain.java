...
public class CompairMain {
	...
	public static void main(String[] args) {
		...
		System.out.println("Sorted by studenID");
		for (Student s:studentList) {
			System.out.println(s);
		}
		...
		System.out.println("===================");
		System.out.println("Sort by name with lamda");
		//Sort by label with lamda
