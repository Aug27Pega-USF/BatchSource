...
CREATE OR REPLACE TRIGGER trf_aftr
AFTER INSERT ON TUITION_REIMBURSEMENT_FORM
FOR EACH ROW

BEGIN
    INSERT INTO TRF_APPROVAL_PACKET (TRF_ID, PROJECTED_REIMBURSEMENT, DS_APPROVAL, DH_APPROVAL) VALUES(new.trf_id, new.PROJECTED_REIMBURSEMENT, new.SUPERVISOR_APPROVAL_EXIST, new.HEAD_APPROVAL_EXIST);
END;
/
