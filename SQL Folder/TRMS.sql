...
INSERT INTO TUITION_REIMBURSEMENT_FORM VALUES (0,'PRESTON','LAU','INFO',TO_DATE('24-DEC-18 12:04', 'DD-MM-YY hh24:mi'), 'LOCATION','DESCRIPTION',34.35,'LETTER GRADE', '70', '2', 'JUSTIFICATION', 'N','N','N', 0, 23.23);

SELECT TO_CHAR( my_date, 'MM-DD-YYYY' ) FROM DUAL;