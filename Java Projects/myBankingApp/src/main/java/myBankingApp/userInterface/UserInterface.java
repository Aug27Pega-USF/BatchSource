			...
			if(x.length() == 1) {
				...
				try {
					...
					case 2:
						...
						break;
					case 3:
						C.applyForAccount(SC, myBank.openAccountApplications, myBank.accountIDList);
						ioBankUI.writeSerializedBankUIFile();	
						break;
					case 4:
						...
						if(C2 != null) {
							C.applyForJointAccount(SC, myBank.openAccountApplications, myBank.accountIDList, C2);
							ioBankUI.writeSerializedBankUIFile();	
						}
						break;
					case 5:
